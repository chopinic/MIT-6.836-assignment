...
void compileProgram(const char* vshader_src, const char* fshader_src, QOpenGLShaderProgram &shaderProgram)
{

    //着色器部分
    QOpenGLShader *vertexShader = new QOpenGLShader(QOpenGLShader::Vertex);
    bool success = vertexShader->compileSourceCode(vshader_src);
    if(!success){
    ...
    success = fragmentShader->compileSourceCode(fshader_src);
    if(!success){
